...
import NicoRueda.ui.PlayableRacesDashboardUI;

import javax.annotation.Nonnull;

/**
 * /race ui - Open the plugin dashboard UI
 *
...
public class UISubCommand extends AbstractPlayerCommand {
    ...
    protected void execute(
        ...
        context.sendMessage(Message.raw("Opening PlayableRaces Dashboard..."));
        ...
        try {
            ...
            PlayableRacesDashboardUI dashboardPage = new PlayableRacesDashboardUI(playerRef);
